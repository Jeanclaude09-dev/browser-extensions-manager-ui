      ...
      {data.map((item) => (
        ...
        >
          ...
          <div className="flex justify-between items-center">
            <button className="text-neutral-900 px-3 py-1.5 rounded-2xl border border-neutral-500 cursor-pointer hover:bg-red-500 hover:text-neutral-0 hover:border-red-500 transition-all duration-200 dark:border-neutral-600 dark:text-white">
              Remove
            </button>
